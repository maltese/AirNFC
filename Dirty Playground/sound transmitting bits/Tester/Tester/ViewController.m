...
- (void)audioEngineDidGetInterrupted:(ADEAudioEngine *)audioEngine hasData:(float *)data bits:(int)errorCount {
    self.errorCountLabel.text = [NSString stringWithFormat:@"%d", errorCount];
